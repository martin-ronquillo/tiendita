        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <br>
                    <input type="number" name="stock" wire:model="stock" class="steps-input" value="1">
                    @error('cantidad') 
                        <span class="error text-danger">{{ $message }}</span> 
                    @enderror
                </div>
                <div class="col-6">
                    ...
                    <br>
                    <input type="number" step="0.01" name="precio" wire:model="precio" class="steps-input" value="1">
                    @error('precio') 
                        <span class="error text-danger">{{ $message }}</span> 
                    @enderror
                </div>
