                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="provincia" id="provincia" class="form-control @error('provincia') is-invalid @enderror" required autofocus>
                                    <option selected disabled>Seleccione una provincia</option>
                                    @foreach (@App\Provincia::all() as $item)
                        ...
                        <div class="form-group row">
                            <label for="direccion_domiciliaria" class="col-md-4 col-form-label text-md-right">{{ __('Direccion Domiciliaria') }}</label>

                            <div class="col-md-6">
                                <input id="direccion_domiciliaria" type="text" class="form-control @error('direccion_domiciliaria') is-invalid @enderror" name="direccion_domiciliaria" value="{{ old('direccion_domiciliaria') }}" required autocomplete="direccion_domiciliaria" autofocus>
                        ...
                        <div class="form-group row mb-0 justify-content-center">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <br>
                                <a href="javascript:history.back()" class="text-secondary mt-2 ml-2">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
